  ...
  >
    ...
    <div class="tw-max-w-6xl tw-mx-auto sm:tw-px-6 lg:tw-px-8">
        ...
        <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2">
          <div class="tw-p-6">
            <div class="tw-flex tw-items-center">
              ...
              <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                <span class="tw-text-gray-900 dark:tw-text-white">Server Driven Notifications</span>
              </div>
            </div>
          ...
          <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700 md:tw-border-t-0 md:tw-border-l">
            <div class="tw-flex tw-items-center">
              ...
              <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                <span class="tw-text-gray-900 dark:tw-text-white">Server Driven Dialogs</span>
              </div>
            </div>
          ...
          <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700 md:tw-border-l">
            <div class="tw-flex tw-items-center">
              ...
              <div
                class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold tw-text-gray-900 dark:tw-text-white"
              >
                Vibrant Ecosystem
              </div>
            </div>
      ...
      <div class="tw-flex tw-justify-center tw-mt-4 sm:tw-items-center sm:tw-justify-between">
        ...
        <div
          class="tw-ml-4 tw-text-center tw-text-sm tw-text-gray-500 sm:tw-text-right sm:tw-ml-0"
        >
